...
*/
void fillAes1Rx4(void *restrict state[64], uint32_t output_size, void *restrict buffer[output_size]) {
...
void fillAes4Rx4(void *restrict state[64], uint32_t output_size, void *restrict buffer[output_size]) {
	assume(output_size % 64 == 0);
